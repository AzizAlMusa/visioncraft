...
int main(int argc, char* argv[]) {
    ...
    const std::string model_path = "../models/abc/0002.stl";   // change as needed
    ...
    const int start_viewpts  = 2;   // baseline
    ...
    float beta1 = 0.95f, beta2 = 0.95f, lr = 0.5f, adam_eps = 1e-8f;
    float lr_decay = 1.0f;
